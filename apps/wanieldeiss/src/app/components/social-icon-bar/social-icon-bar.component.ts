...
@Component({
  ...
  template: `
    <nav
      aria-label="Social"
      class="fixed bottom-4 right-0 flex flex-row items-center space-x-4 text-fg-muted md:bottom-0 md:right-12 md:flex-col md:space-x-0 md:space-y-4"
    >
      @for (link of socialLinks; track link.label) {
        <a
          ...
          class="focus-ring transition-colors hover:text-fg-strong"
        >
      ...
      <div
        class="h-0.5 w-32 bg-border md:h-32 md:w-0.5"
        aria-hidden="true"
      ></div>
    </nav>
  `,
  ...
  protected readonly socialLinks: readonly SocialLink[] = [
    {
      ...
      link: 'https://www.linkedin.com/in/wanieldeiss/',
    },
    {
      label: 'Instagram',
      svgPath:
      ...
      link: 'https://www.instagram.com/wanieldeiss/',
    },
    {
      label: 'GitHub',
      svgPath:
      ...
      link: 'https://github.com/WanielDeiss',
    },
  ];
}
